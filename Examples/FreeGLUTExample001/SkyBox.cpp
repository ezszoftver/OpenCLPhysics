...
void SkyBox::Load(std::string strDir, std::string strBack, std::string strDown, std::string strFront, std::string strLeft, std::string strRight, std::string strUp)
{
    // back
    texture[0].Load((strDir + strBack), Texture::REPEAT_OFF);
    ...
    // down
    texture[1].Load((strDir + strDown), Texture::REPEAT_OFF);
    ...
    // front
    texture[2].Load((strDir + strFront), Texture::REPEAT_OFF);
    ...
    // left
    texture[3].Load((strDir + strLeft), Texture::REPEAT_OFF);
    ...
    // right
    texture[4].Load((strDir + strRight), Texture::REPEAT_OFF);
    ...
    // up
    texture[5].Load((strDir + strUp), Texture::REPEAT_OFF);
