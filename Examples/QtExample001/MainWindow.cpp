    ...
    for (int x = -5; x < 5; x++)
    {
        //for (int z = -5; z < 5; z++)
        {
            ...
            for (int y = 0; y < 1; y++)
            {
                ...
                m_physics.SetPosition(dynamic_id, glm::vec3(x * fScale, 0.8f + (y * fScale), 12));
                m_physics.SetEulerRotate(dynamic_id, glm::vec3(0.1f, 0.2f, 0.3f));
                ...
                m_physics.SetRestitution(dynamic_id, 0.5f);
